...
import com.pvt.tracker.util.Reflector;
...
/**
 * Realization major controller, encapsulating all the logic of working with objects:
...
public class MainController {
	 ...
	 * Например, URL вида http://localhost/tracker/tasks/info/1 означает, что у нас есть контроллер
	 * с названием ModelController (часть /tasks/ нашего URL), у этого контроллера есть метод info
	...
	private void processUrl(String url) {
		try {
			...
			Class<?> clazz = Class.forName("com.pvt.tracker.controller." + map.get("controller"));
